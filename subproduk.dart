...
import 'package:projek_besar/produk.dart';
import 'InputDeco_desain.dart';
import 'dart:core';

class Subproduk extends StatefulWidget {
  const Subproduk({Key? key, required arguments}) : super(key: key);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: buildInputDecoration(Icons.numbers, "Id Narang"),
                        validator: (value) {
                          if (value!.isEmpty) {
